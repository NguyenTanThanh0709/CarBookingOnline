...
function PartnerVeXeRe() {
    return ( 
        <div className="bg-slate-50 m-2 p-2">
            <Row>
                <Col className="m-2">
                    <h1 className="fw-bold fs-1">LIÊN HỆ VỚI CHÚNG TÔI</h1>
                    <div className="mt-4">
                        <h2 className="text-orange-400">
                            CÔNG TY CỔ PHẦN XE KHÁCH VÉ XE RẺ- VEXERE BUS LINES
                        </h2>
                        <div className="flex mt-4">
                            <span className="text-stone-400">Địa chỉ:</span> <p className="ml-2">Số 01 Tô Hiến Thành, Phường 3, Thành phố Đà Lạt, Tỉnh Lâm Đồng, Việt Nam</p>
                        </div>
                        <div className="flex">
                            <span className="text-stone-400">Website:</span> <p className="ml-2">https://futabus.vn/</p>
                        </div>
                        <div className="flex">
                            <span className="text-stone-400">Hotline:</span> <p className="ml-2">02838386852</p>
                        </div>
                        <div className="flex">
                            <span className="text-stone-400">Số điện thoại</span> <p className="ml-2">02838386852</p>
                        </div>
                        <div className="flex">
                            <span className="text-stone-400">Email</span> <p className="ml-2">hotro@futa.vn</p>
                        </div>
                    </div>

                </Col>
                <Col>
                <h1 className="fw-bold fs-1">GỬI THÔNG TIN  VỚI CHÚNG TÔI</h1>
                <form>
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="email" name="floating_email" id="floating_email" class="block py-2.5 px-0 w-full  text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="floating_first_name" id="2121" class="block py-2.5 px-0 w-full  text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="floating_last_name" id="floating_last_name" class="block py-2.5 px-0 w-full  text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" name="floating_phone" id="floating_phone" class="block py-2.5 px-0 w-full  text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
